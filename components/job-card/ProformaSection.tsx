...
import { FileText, Plus, Trash2, Loader2, Check, ChevronDown, MessageCircle, Edit2, X } from 'lucide-react'
...
export default function ProformaSection({
  ...
  const isLocked = jobStatus === 'delivered' || jobStatus === 'cancelled'
