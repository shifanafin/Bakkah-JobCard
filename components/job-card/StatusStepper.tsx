...
// pending/assigned are pre-work steps; in_progress onward is the work flow
const STEPS: JobStatus[] = ['pending', 'assigned', 'in_progress', 'qc_check', 'ready', 'delivered']

export default function StatusStepper({ jobId, currentStatus, hasTechnician, onUpdate }: {
  jobId: string
  ...
  // received is a legacy status — treat it as step 0 (pending)
  ...
  const canAdvance =
    ...
    // can't advance from pending without a technician
            ...
            <div key={step} className="flex flex-1 items-center last:flex-none">
              <div className="flex flex-col items-center">
                ...
                <span className={cn('mt-1.5 text-[10px] font-semibold whitespace-nowrap',
                  active ? 'text-brand' : done ? 'text-emerald-400' : 'text-gray-300 dark:text-white/30'
