    ...
    <div className="card space-y-4">
      ...
      <div className="border-b border-gray-100 pb-3 dark:border-white/[0.06] space-y-2">
        <div className="flex items-center gap-2">
          <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-amber-100 dark:bg-amber-500/15 shrink-0">
            <FileText className="h-3.5 w-3.5 text-amber-600 dark:text-amber-400" />
          </div>
          <h3 className="section-title">Quotation</h3>
          {quotation && (
            <span className={cn('rounded-full px-2.5 py-0.5 text-xs font-bold ml-auto', STATUS_BADGE[quotation.status]?.cls)}>
                          ...
                          {!readOnly && (
                            <div className="flex shrink-0 -mr-1">
                              <button
                                ...
                                disabled={isPending}
                                className="p-2 text-gray-400 active:text-brand transition-colors rounded-lg">
