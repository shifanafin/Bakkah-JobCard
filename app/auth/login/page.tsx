    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-surface-900">
      ...
      <div className="relative z-10 w-full max-w-sm px-4">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-white/40">Workshop Management System</p>
        </div>

        <div className="card border-white/[0.08] bg-surface-800/80 backdrop-blur-xl">
          <h2 className="mb-6 text-lg font-bold text-white">Sign in to your account</h2>
          ...
          {/* Demo credentials */}
          <div className="mt-5 space-y-1.5 rounded-lg border border-white/[0.06] bg-white/[0.03] p-3">
            <p className="text-[11px] font-semibold uppercase tracking-wider text-white/30">Demo credentials</p>
            <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
              <span className="text-white/30">Email</span>
              <span className="font-mono text-white/60">admin@autoedgepro.ae</span>
