            ...
            {rta && (
              <div className="mb-7 rounded-xl border border-blue-100 bg-blue-50/50 p-5">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-[10px] font-black uppercase tracking-widest text-blue-600">UAE Vehicle Status</h2>
                  {rta.data_source && rta.data_source !== 'manual' && (
                    <span className="ml-auto text-[9px] uppercase tracking-wider text-blue-400 font-bold">Verified via RTA</span>
                  )}
                </div>
                  ...
                  <div className="flex items-center justify-between rounded-lg bg-white border border-blue-100 px-3 py-2.5 mb-3 text-sm">
                    ...
                    <div className="text-right">
                      ...
                      {rta.salik_balance_aed != null && (
                        <span className="ml-3 font-black text-blue-600">AED {rta.salik_balance_aed.toFixed(2)}</span>
                      )}
                    </div>
                  </div>
                )}
